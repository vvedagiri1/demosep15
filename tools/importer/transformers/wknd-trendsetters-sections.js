 ...
 * Selectors originate from page analysis (DOM-verified against cleaned.html):
 *   e.g. "#main-content > header.section.secondary-section".
 *
 * Sections with a style (get Section Metadata): rc3 (grey), rc5 (grey).
 * Section breaks (<hr>): one before each section except the first (6 total).
 *
